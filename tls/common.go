...
import (
	...
	"errors"
	"fmt"
	"github.com/tumi8/goscanner/tls/internal/cpu"
	"io"
	"math/big"
	"net"
	"strings"
...
// TLS Extension exported (copied to prevent git changes for later updates)
const (
	ExtensionServerName                     = extensionServerName
	ExtensionStatusRequest                  = extensionStatusRequest
	ExtensionSupportedCurves                = extensionSupportedCurves
	ExtensionSupportedPoints                = extensionSupportedPoints
	ExtensionSignatureAlgorithms            = extensionSignatureAlgorithms
	ExtensionALPN                           = extensionALPN
	ExtensionSCT                            = extensionSCT
	ExtensionSessionTicket                  = extensionSessionTicket
	ExtensionPreSharedKey                   = extensionPreSharedKey
	ExtensionEarlyData                      = extensionEarlyData
	ExtensionSupportedVersions              = extensionSupportedVersions
	ExtensionCookie                         = extensionCookie
	ExtensionPSKModes                       = extensionPSKModes
	ExtensionCertificateAuthorities         = extensionCertificateAuthorities
	ExtensionSignatureAlgorithmsCert        = extensionSignatureAlgorithmsCert
...
type Config struct {
	...
	ClientHelloPreset *ClientHelloPreset
