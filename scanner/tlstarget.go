...
func (h *CertHostTLSTarget) Dump(hostFh, certFh, chrFh, scsvFh, httpFh *os.File, timediff time.Duration, certCache scanCache, cipherSuites map[uint16]string, skipErrors bool, cacheFunc func([]byte) []byte) error {
